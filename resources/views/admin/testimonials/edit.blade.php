            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="testimonialForm" method="post"
                        action="{{ route('testimonials.update', ['testimonial' => $testimonial]) }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Quote</label>
                                <textarea class="form-control" rows="3" name="quote"
                                    placeholder="Enter quote">{{ $testimonial->quote }}</textarea>
                            </div>
                            <div class="form-group">
